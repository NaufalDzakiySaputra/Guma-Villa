        ...
        <div class="col-2">
            <div class="card text-center py-2">
                <div class="card-body">
                    ...
                    <h4 class="text-danger">{{ $unpaidCount }}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-2">
            <div class="card text-center py-2">
                <div class="card-body">
                    ...
                    <h4 class="text-info">{{ $paidCount }}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-2">
            <div class="card text-center py-2">
                <div class="card-body">
                    ...
                    <h4 class="text-success">{{ $verifiedCount }}</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" class="row g-2 align-items-center">
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn-filter-admin w-100">
                        Filter
                    </button>
                </div>

                <div class="col-md-2">
                    <a href="{{ route('admin.reservations.index') }}" class="btn-reset-admin w-100">
                        Reset
                    </a>
                </div>
            </form>
