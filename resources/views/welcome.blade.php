        ...
        <div class="container py-5">
                ...
                <div class="col-md-8">
                    <div class="card user-info-card">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                @if(Auth::user()->role === 'admin')
                                <a href="{{ route('admin.dashboard') }}" class="btn btn-sm btn-primary me-2">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-3 mb-4">
                                    <a href="{{ route('login') }}" class="btn-guma">
                                        <i class="fas fa-sign-in-alt me-2"></i>Login
                                    </a>
                                    <a href="{{ route('register') }}" class="btn btn-outline-accent" style="border-color: #A0522D; color: #A0522D;">
            ...
            <footer class="mt-5 pt-4 border-top text-center">
                <p class="text-muted">
                    ...
                    &copy; {{ date('Y') }} Guma Landscape Cafe & Resort. All rights reserved.
                </p>
