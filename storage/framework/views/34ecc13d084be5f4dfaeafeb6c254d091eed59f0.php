                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="small text-muted mt-2">
                            ...
                            ?>
                            Villa: <?php echo e($villaCount); ?> • Wisata: <?php echo e($wisataCount); ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="small text-muted mt-2">
                            ...
                            ?>
                            Diskon: <?php echo e($diskonCount); ?> • Avg: Rp <?php echo e(number_format($avgPrice, 0, ',', '.')); ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="small text-muted mt-2">
                            ...
                            ?>
                            Minggu Ini: <?php echo e($thisWeek); ?> • Bulan Ini: <?php echo e($thisMonth); ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="small text-muted mt-2">
                            ...
                            ?>
                            Terbaru: <?php echo e($recentGallery); ?> • Total: <?php echo e(App\Models\Gallery::count()); ?>
        ...
        <div class="card h-100">
            <div class="card-header">
                <h6 class="mb-0">
                    ...
                    Kalender Event <?php echo e(now()->translatedFormat('F Y')); ?>
            ...
            <div class="card-body">
                ...
                <div class="text-center mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <h5 class="mb-0"><?php echo e(now()->translatedFormat('F Y')); ?></h5>
                        <button class="btn btn-sm btn-outline-secondary">
                    ...
                    <!-- Day Headers -->
                    <div class="row mb-2">
                        <?php $__currentLoopData = ['M', 'S', 'S', 'R', 'K', 'J', 'S']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col p-2 text-center">
                            <small class="text-muted"><?php echo e($day); ?></small>
                        </div>
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="col p-2 text-center">
                            <div class="calendar-day <?php echo e($isToday ? 'bg-accent text-white rounded-circle' : ''); ?> 
                                          <?php echo e($hasEvent ? 'border border-success' : ''); ?>"
                ...
                <?php if($eventsThisMonth->isEmpty()): ?>
                <p class="text-muted">Tidak ada event di bulan ini</p>
                <?php else: ?>
                <div class="list-group">
                    <?php $__currentLoopData = $eventsThisMonth->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <strong><?php echo e($event->title); ?></strong>
                                <div class="small text-muted">
                                    <?php echo e($event->event_date->translatedFormat('l, d F Y')); ?>
                    ...
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <strong><?php echo e($event->title); ?></strong>
                                <div class="small">
                                    <?php echo e($event->event_date->translatedFormat('d F')); ?>

                                    <span class="text-success ms-2">
                                        (<?php echo e(now()->diffInDays($event->event_date)); ?> hari lagi)
                                    </span>
                                </div>
                            </div>
                            <a href="<?php echo e(route('news.edit', $event->id)); ?>" 
                        ...
                        <div class="card bg-light border-0 mb-3">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <?php if($latestPackage->image_path): ?>
                                    <img src="<?php echo e(asset('storage/' . $latestPackage->image_path)); ?>" 
                                         alt="<?php echo e($latestPackage->nama); ?>"
                                         class="rounded me-2"
                                         style="width: 40px; height: 40px; object-fit: cover;">
                                    <?php endif; ?>
                                    <div>
                                        <strong class="d-block"><?php echo e(Str::limit($latestPackage->nama, 20)); ?></strong>
                                        <small class="text-muted">
                                            Rp <?php echo e(number_format($latestPackage->price, 0, ',', '.')); ?>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light border-0 mb-3">
                            <div class="card-body">
                                ...
                                <?php if($discountMenu): ?>
                                <div>
                                    <strong class="d-block"><?php echo e($discountMenu->name); ?></strong>
                                    <div>
                                        <span class="text-decoration-line-through text-muted small">
                                            Rp <?php echo e(number_format($discountMenu->price, 0, ',', '.')); ?>

                                        </span>
                                        <span class="text-success fw-bold ms-2">
                                            -<?php echo e($discountMenu->discount); ?>%
                                        </span>
                                    </div>
                                </div>
                                <?php else: ?>
                        ...
                        <div class="position-relative">
                            ...
                            <div class="position-absolute bottom-0 start-0 w-100 p-2" 
                                ...
                                <p class="text-white mb-0 small">
                                    <?php echo e($gallery->title ? Str::limit($gallery->title, 15) : 'Foto'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Guma_Villa\guma-landscape\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>